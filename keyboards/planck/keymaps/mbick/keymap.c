...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    XXXXXXX,        TG(_VIM), KC_LALT, KC_LGUI, NUMS, HYPR_T(KC_SPC), HYPR_T(KC_SPC), SYMB, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_SYMB] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_UNDS, KC_PLUS, XXXXXXX, XXXXXXX, KC_PGUP, KC_PGUP, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),

[_VIM] = LAYOUT_planck_grid(
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TG(_VIM), XXXXXXX, XXXXXXX, XXXXXXX,
